...
function buildStats(fetchedDatasets, currencyMetadata) {
  ...
  return {
    ...
    metrics: [
      ...
      {
        id: 'smokingLess20',
        label: 'Daily smokers, under 20 cigarettes per day',
        unit: '%',
        dataset: 'hlth_ehis_sk3i',
      },
      {
        id: 'smoking20Plus',
        label: 'Daily smokers, 20+ cigarettes per day',
        unit: '%',
        dataset: 'hlth_ehis_sk3i',
      },
      {
    ...
    notes: [
      ...
      'Income statistics also include euro and national-currency values from Eurostat units EUR and NAC.',
      ...
      'Heavy episodic drinking means more than 60 g of pure ethanol on one occasion; the displayed value combines weekly responses with monthly responses that are not weekly.',
